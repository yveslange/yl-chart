...
(function() {
  ...
  AgChart = (function() {
    ...
    AgChart.prototype.renderLabel = function(params) {
      if (params == null) {
        params = {
          label: {
            color: null,
    ...
    AgChart.prototype.renderPoints = function() {
      ...
      if (_conf.canvas.render === 'dots') {
        ...
        return series.selectAll(".circle").data(function(d) {
          ...
          return _tooltipShow(conf, _tooltipNode, d);
    ...
    AgChart.prototype.tooltip = {
      show: function(conf, tooltipNode, d) {
        var heightTooltip, left, top, widthTooltip;
        ...
        if (conf.tooltip.alwaysInside) {
          if (d3.event.pageX > conf.canvas.width / 2.0) {
            ...
            left = d3.event.pageX - d.config.stroke.width - widthTooltip - 10;
          }
          if (d3.event.pageY > conf.canvas.height / 2.0) {
            heightTooltip = parseFloat(tooltipNode.style('height').replace("px", ''));
            top = d3.event.pageY - d.config.stroke.width - heightTooltip - 10;
          }
        }
